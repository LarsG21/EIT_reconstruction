...
def trainings_loop(model: nn.Module, model_name: str, path_to_training_data: str, learning_rate: float, num_epochs: int,
    ...
    # if not any(x in training_data_path.lower() for x in ["multi", "abolute"]) and ABSOLUTE_EIT:
...
if __name__ == "__main__":
    model_name = "Run_16_12"
    path = "../Training_Data/3_Freq"
    # training_data_path = "../Collected_Data_Variation_Experiments/High_Variation_multi"
    # training_data_path = "../Collected_Data/Combined_dataset"
    num_epochs = 100
    learning_rate = 0.001
    pca_components = 128
