...
# def combine_multiple_data_files():
#     """
#     Combine the data files generated by the simulation into one file
#     :return:
#     """
#     img_array_np_load = None
#     v1_array_np_load = None
#     for i in range(1, 10):
#         img_array = np.load(f"Own_Simulation_Dataset/img_array_{i}.npy")
#         v1_array = np.load(f"Own_Simulation_Dataset/v1_array_{i}.npy")
#         if img_array_np_load is None:
#             img_array_np_load = img_array
#             v1_array_np_load = v1_array
#         else:
#             img_array_np_load = np.concatenate((img_array_np_load, img_array), axis=0)
#             v1_array_np_load = np.concatenate((v1_array_np_load, v1_array), axis=0)
#         print(img_array.shape)
#         print(v1_array.shape)
#     np.save("Own_Simulation_Dataset/img_array_complete.npy", img_array_np_load)
#     np.save("Own_Simulation_Dataset/v1_array_complete.npy", v1_array_np_load)
#
#     average_image = np.mean(img_array_np_load, axis=0)
